...
public class ReadData2 {
    ...
    @Value("${model.host:tcp://192.168.1.107:61613}")
    public static final String HOST = "tcp://192.168.1.107:61613";
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ReadData2.class);
